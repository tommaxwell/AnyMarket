class User < ActiveRecord::Base
  ...
  devise :database_authenticatable, :registerable,
	:recoverable, :rememberable, :trackable, :validatable, :token_validatable, :confirmable
  ...
  def mailboxer_email(object)
	...
	## validates :email, uniqueness: true, format: { with: /\b[A-Z0-9._%a-z\-]+@berkeley\.edu\z/, message: "must be a Berkeley.edu email" }
